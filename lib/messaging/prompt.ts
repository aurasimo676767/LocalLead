...
export function outreachInstructions(
  ...
  return [
    "Scrivi un DM italiano personale per WhatsApp o Facebook. Restituisci l'oggetto richiesto con text ed evidence_ids: gli ID devono sostenere le osservazioni nel testo.",
    ...
    "Una sola osservazione concreta e un'idea collegata. Scrivi come in una conversazione, senza complimenti di circostanza, elenchi di funzionalità o frasi riempitive. Non forzare una sequenza fissa: complimento, problema, vendita. Non fingere di essere cliente o di aver visitato il locale.",
    "Evita punto di riferimento, ottima reputazione, valorizzare, presenza online, soluzione, esperienza digitale, opportunità, clientela, professionale, ottimizzare, senza impegno, con calma e rendere tutto più comodo. Non convertire le recensioni in elogi.",
    ...
    "Non proporre prenotazioni online o promettere risultati. Varia apertura, ritmo e chiusura rispetto agli ultimi 15 messaggi, mantenendo i fatti.",
    attempt
